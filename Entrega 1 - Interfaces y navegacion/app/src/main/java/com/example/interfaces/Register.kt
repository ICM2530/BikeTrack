...
@Composable
fun RegisScreen(navController: NavHostController, name: String? = "User") {
    ...
    {paddingValues ->
        Column(
            ...
            Card(
                modifier = Modifier.width(370.dp).height(440.dp),
                ...
                Column(
                    ...
                    Text("Register", color = Color.White, fontSize = 28.sp, fontWeight = FontWeight.Bold)
